...
characters = {
    "예수": ["여러종교의 수장", "https://i.namu.wiki/i/LS4tiFgORcRdUTAegBruVYmbgDfquOdCqu4sm-YxSiMzgcx5xkJB7GupVXXU98IwGF92KrsdjGQehhCHVhjm6g.webp"],
    "부처": ["불교의 수장", "https://jpassets.jobplanet.co.kr/production/uploads/company_story/contents/2021/05/20/561e9fd3-7cce-42b4-9432-592421df4407.jpg"]
}


# 사용자 아바타 이미지 URL
user_avatar_url = "https://img.freepik.com/premium-photo/funny-sheep_9493-11264.jpg"
...
def generate_conversation(language, character, user_input):
    ...
    [예수]: [https://namu.wiki/w/%EC%98%88%EC%88%98], 말투는 점잖고 신같은 말투로 해주세요.
    [부처]: [https://namu.wiki/w/%EC%84%9D%EA%B0%80%EB%AA%A8%EB%8B%88], 말투는 심리적 안정을 주는 점잖은 신같은 말투로 해주세요.
